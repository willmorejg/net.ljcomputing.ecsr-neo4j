...
@Service
@Transactional
public class TeamEmailServiceImpl extends
  ...
  public void setRepository(
      final PersonalityContactRepository<PersonalityContactImpl<Team, EmailContact>> repository) {
