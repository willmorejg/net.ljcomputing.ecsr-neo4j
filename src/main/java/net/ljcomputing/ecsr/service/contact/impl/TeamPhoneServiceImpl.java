...
@Service
@Transactional
public class TeamPhoneServiceImpl extends
    AbstractPersonalityContactServiceImpl
    <PersonalityContactImpl<Team, PhoneContact>, Team, 
    PhoneContact,
    PersonalityContactRepository<PersonalityContactImpl<Team, PhoneContact>>>
    implements TeamPhoneService {
  ...
  public void setRepository(
      final PersonalityContactRepository<PersonalityContactImpl<Team, PhoneContact>> repository) {
