...
@Service
@Transactional
public class PersonMailServiceImpl extends
  ...
  public void setRepository(
      final PersonalityContactRepository<PersonalityContactImpl<Person, MailContact>> repository) {
