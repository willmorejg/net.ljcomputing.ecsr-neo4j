...
@Service
@Transactional
public class OrganizationPhoneServiceImpl extends
    AbstractPersonalityContactServiceImpl
    <PersonalityContactImpl<Organization, PhoneContact>, Organization, 
    PhoneContact,
    PersonalityContactRepository<PersonalityContactImpl<Organization, PhoneContact>>>
    implements OrganizationPhoneService {
  ...
  public void setRepository(
      PersonalityContactRepository<PersonalityContactImpl<Organization, PhoneContact>> repository) {
